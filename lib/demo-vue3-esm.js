...
function createRenderer(option) {
    const { createElement: hostCreateElement, patchProp: hostPatchProp, insert: hostInsert, removeChildren: hostRemoveChildren, createTextNode: hoseCreateTextNode, } = option;
    ...
    function patchChildren(n1, n2, container, parent) {
        ...
        if (prevFlag & 8 /* ShapeFlag.ARRAY_CHILDREN */) {
            ...
            if (nextFlag & 8 /* ShapeFlag.ARRAY_CHILDREN */) {
...
export { ReactiveFlags, createApp, createRenderer, createTextVNode, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, provide, proxyRefs, reactive, readonly, ref, renderSlot, shallowReadonly, unRef };
